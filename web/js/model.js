...
const BUILTIN_KINDS = {
  ...
  quote:   {shape:'quote', nm:'Quote',   ic:'book',    c:'#6F5137', key:'Z', ds:'Someone else\'s words',      size:[6,4], onclick:'read', attrs:['text','link','rating'],
            body:'> \n\n— ' },
  story:   {shape:'spine', narrative:true, nm:'Story',   ic:'book',    c:'#5A4130', key:'M', ds:'A book on the shelf', size:[3,9], onclick:'book', attrs:['text'],
            body:'' },
  scene:   {shape:'page', narrative:true, film:true, nm:'Scene',   ic:'clapper', c:'#2F4A5E', key:'N', ds:'One scene, for writing',     size:[6,5], onclick:'read', attrs:['text','location','duration'],
            body:'**Where —** \n\n**Who —** \n\n**What changes —** ' },
  character:{shape:'portrait', narrative:true, nm:'Character', ic:'star', c:'#A0703F', key:'H', ds:'Someone in the story',       size:[4,6], onclick:'read', attrs:['text','media'],
            body:'**Wants —** \n\n**Fears —** \n\n**Voice —** ' },
  ...
  place:   {shape:'card', nm:'Place',   ic:'flag',    c:'#6B7A3F', key:'1', ds:'Somewhere in the story',  size:[5,6], onclick:'read', attrs:['text','media'], narrative:true,
            body:'**Feels like —** \n\n**Who is there —** \n\n**What happened here —** ' },
  event:   {shape:'card', nm:'Event',   ic:'clock',   c:'#8C4A38', key:'2', ds:'Something that happens',  size:[6,4], onclick:'read', attrs:['text','date'], narrative:true,
            body:'**Before —** \n\n**The turn —** \n\n**After —** ' },
  item:    {shape:'card', nm:'Item',    ic:'star',    c:'#9A7B2F', key:'3', ds:'A thing that matters',    size:[4,4], onclick:'read', attrs:['text','media'], narrative:true,
            body:'**What it is —** \n\n**Who wants it —** ' },
